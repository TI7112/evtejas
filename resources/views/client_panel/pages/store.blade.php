...
@section('content')
    ...
    <div class="bg-[url('assets/static/background.webp')] bg-fixed bg-cover w-full min-h-screen">
        <div class="bg-[rgba(0,0,0,0.7)] w-full gap-1 py-12 md:py-0 min-h-screen text-white flex flex-col justify-center items-center">
                ...
                <div class="container px-5 mx-auto">
                    <div class="flex justify-between">
                        ...
                        <div class="hidden md:flex gap-5 items-center">
                            ...
                            <select
                                class="evcategory capitalize bg-zinc-900  outline-none border-2 p-2 text-xs md:text-lg rounded-lg font-bold"
                                name="evcategory">
