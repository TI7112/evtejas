...
Route::get('/about-tejas', [clientController::class, "about_tejas"])->name('about_tejas');
Route::get('/about-tejas-ev', [clientController::class, "about_tejas_ev"])->name('about_tejas_ev');
Route::get('/about-vision-and-value', [clientController::class, "about_vision"])->name('about_vision');
Route::get('/about-mission', [clientController::class, "about_mission"])->name('about_mission');
Route::get('/about-office', [clientController::class, "about_office"])->name('about_office');
...
Route::get('/api', function () {
    ...
    foreach($data as $value){
        if(substr($value->slug , -3) != "pro"){
            $feature = Feature::where('product_id' , "$value->id")->first();
            // echo "<pre>";
            $feature->battery = "lead";
